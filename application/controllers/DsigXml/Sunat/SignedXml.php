...
namespace DsigXml\Sunat;

use DOMDocument;
use DsigXml\XMLSecEnc;
use DsigXml\XMLSecurityDSig;
use DsigXml\XMLSecurityKey;
use RuntimeException;
use UnexpectedValueException;

require APPPATH . '/controllers/DsigXml/XMLSecEnc.php';
require APPPATH . '/controllers/DsigXml/XMLSecurityDSig.php';
require APPPATH . '/controllers/DsigXml/XMLSecurityKey.php';
/**
 * Class SignedXml
 */
class SignedXml
{
    ...
    public function setCertificateFromByte($filename)
    {
