...
class CustomHeaders extends SoapHeader{
  ...
  function __construct($user, $pass, $ns = null) 
   { 
    ...
    $security_sv = new SoapVar( new SoapVar($username_token, SOAP_ENC_OBJECT, NULL, 
                   $this->wss_ns, 'UsernameToken', $this->wss_ns), SOAP_ENC_OBJECT, NULL, 
